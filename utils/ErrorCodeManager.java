...
public final class ErrorCodeManager {
    ...
    public static String getVcsBadPathStr() {
        return VCS_BAD_PATH_STR;
    }

    private static final String VCS_BAD_PATH_STR = "Vcs: Bad path";

    public static String getVcsStagedOpStr() {
        return VCS_STAGED_OP_STR;
    }
    ...
    public static String getVcsBadCmdStr() {
        return VCS_BAD_CMD_STR;
    }
